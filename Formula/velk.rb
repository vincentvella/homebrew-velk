class Velk < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "a8ecd27de23c3642c09075ff14315f17094f85a0c98cc6f1dedd688dba86383b"
    end
    on_intel do
      url "https://github.com/vincentvella/velk/releases/download/v#{version}/velk-darwin-x64.tar.gz"
      sha256 "3a318e3f41ce6240ed14badf04c447d6ce49a09db238fdace0448f30b8b5bda4"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "b6a1a0f5fe0c6765a5d2d503949275949fefd862c1adc927e876f6b0fbab8ebc"
    end
    on_intel do
      url "https://github.com/vincentvella/velk/releases/download/v#{version}/velk-linux-x64.tar.gz"
      sha256 "9871db6590929e73084d4620007cf44473035c453c49ad64f58521c132a54ef6"
    end
  end
